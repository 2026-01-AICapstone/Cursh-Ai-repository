...
LORA_PATH = "./out/test/beta"
CENTROIDS_PATH = "./out/test/beta/crush_centroids.pt"
INIT_CENTROIDS_PATH = "./out/test/beta/crush_centroids_initial.pt"

FAILED_JSONL_PATH = "./semantic_final_clear_only_389_FIXED.jsonl"
